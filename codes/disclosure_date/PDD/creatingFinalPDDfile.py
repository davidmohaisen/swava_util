...
f1 = open('./part1/public_distribution_date_overall.csv', 'rb')
f2 = open('./part2/public_distribution_date_overall.csv', 'rb')
f3 = open('./part3/public_distribution_date_overall.csv', 'rb')
f4 = open('./part4/public_distribution_date_overall.csv', 'rb')
f5 = open('./part5/public_distribution_date_overall.csv', 'rb')
...
for cve in cve_publishedDate:
    ...
    # with open('./cve_pdd_diff.csv', 'a') as foo:
    #     foo.write(out+'\n')
