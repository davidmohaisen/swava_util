...
vendorChain = open('../output2.0/vendorChains-Final.xlsx', 'rb')
vendorChainsProdFile = open('../output2.0/vendorChainsProds-Final.xlsx', 'rb')
...
for line3 in vendorProdWoTkn:
    ...
    f+=1
    print(vend, prod)
    with open('../output2.0/vendorChains_OtherNVDvendors.xlsx', 'a') as fw:
