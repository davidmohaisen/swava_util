...
for vendor1 in vendorSet:
    ...
    for prod in prodset:
        ...
        if prod in checkin:# and prod not in ignorableProds:
            ...
            #     continue
            if len(matchedstring) >= 3 or len(matchedstring)< 1:
                continue
            ...
            if prod in vendor1 or vendor1 in prod:
                ...
                # c+=1
                # print(out)
                # if str(prod) + ":" + str(vendor1) not in uniques and str(vendor1) + ":" + str(prod) not in uniques:
                #     uniques.add(str(prod) + ":" + str(vendor1))
                # uniqueVendors.add(prod)
                # uniqueVendors.add(vendor1)
...
print(uniques)
print(len(uniques))
print("unique vendors", len(uniqueVendors))
# for itm in uniques:
#     with open('../lt3_vendor_xyz.txt', 'a') as foout:
#         foout.write(itm+"\n")
#     print(itm+"\n")