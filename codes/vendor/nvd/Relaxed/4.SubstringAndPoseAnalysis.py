...
relaxed = open('./outputRel/possibilities.xlsx', 'rb')
...
with open('./outputRel/vendorChains-Final.xlsx', 'w') as f:
...
for itmVp in inconsistencyRemovedVendProducts:
    with open('./outputRel/vendorChainsProds-Final.xlsx', 'a') as f:
